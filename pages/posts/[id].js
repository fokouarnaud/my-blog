                                ...
                                <div className=" pr-2 grow-0 shrink-0 basis-auto">
                                  <div>
                                    <div className="inline-block">
                                      <button className="m-0 p-0">
                                        <span className="py-3 px-1">
                                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" class="ma" aria-label="Add to list bookmark button"><path d="M18 2.5a.5.5 0 0 1 1 0V5h2.5a.5.5 0 0 1 0 1H19v2.5a.5.5 0 1 1-1 0V6h-2.5a.5.5 0 0 1 0-1H18V2.5zM7 7a1 1 0 0 1 1-1h3.5a.5.5 0 0 0 0-1H8a2 2 0 0 0-2 2v14a.5.5 0 0 0 .8.4l5.7-4.4 5.7 4.4a.5.5 0 0 0 .8-.4v-8.5a.5.5 0 0 0-1 0v7.48l-5.2-4a.5.5 0 0 0-.6 0l-5.2 4V7z" fill="#292929"></path></svg>
                                        </span>
                                      </button>
                                    </div>
                                  </div>
